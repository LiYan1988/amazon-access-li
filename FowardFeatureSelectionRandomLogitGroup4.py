...
Forward feature selection using random logistic regression and group 4 features
"""
...
Y = average_models(x_train, x_test, y_train, cols_drop, [4], 3, 0, 
    model_logit, 20, 10)
y_pred = np.mean(Y,1)
save_submission(y_pred, 'submissionALRG4.csv')